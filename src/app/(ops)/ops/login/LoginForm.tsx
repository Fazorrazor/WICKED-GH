        ...
        <>
          <div className="flex flex-col gap-3 animate-in fade-in zoom-in duration-300">
            ...
            <div className="relative w-full h-[3.25rem]">
              ...
              />
              <div className="absolute inset-0 w-full h-full bg-[#111113] p-4 text-[0.8rem] font-mono tracking-wider text-white flex items-center pointer-events-none border border-transparent">
