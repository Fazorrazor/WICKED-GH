...
function NavItem({
  ...
  return (
    <Link
      href={href}
      className={`flex items-center gap-3 px-3 py-2.5 text-[0.7rem] uppercase tracking-[0.15em] transition-all group relative overflow-hidden ${active ? "text-white bg-[#141416]" : "text-[#A7A7AA] hover:bg-[#141416] hover:text-white"}`}
    >
      {active && (
