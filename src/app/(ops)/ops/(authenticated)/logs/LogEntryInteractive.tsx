...
export function LogEntryInteractive({ log }: { log: any }) {
  ...
  const color = colors[log.level as keyof typeof colors] || "text-white";
      ...
      <div className="w-full h-full flex flex-col relative overflow-hidden font-mono">
        ...
        <header className="p-6 border-b border-[#141416] flex justify-between items-center bg-[#070708] shrink-0">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-[1rem] font-bold uppercase tracking-[0.2em] text-white">
              Telemetry Inspector
            </h2>
          </div>
    ...
    <>
      ...
      >
        <div className="flex gap-4 items-start">
          ...
          <span className="text-[#A7A7AA] flex-1 break-words group-hover:text-white transition-colors">
            {log.message}
            {log.metadata?.target && (
...
function AIAnalysis({ log }: { log: any }) {
  if (log.level === "security") {
    return (
      <div className="flex flex-col gap-4">
        <p>
          <strong className="text-white">Overview:</strong> The system
  ...
  if (log.level === "audit") {
    return (
      <div className="flex flex-col gap-4">
        <p>
          <strong className="text-white">Overview:</strong> Standard
  ...
  if (log.level === "error") {
    return (
      <div className="flex flex-col gap-4">
        <p>
          <strong className="text-white">Overview:</strong> An unhandled
  ...
  return (
    <div className="flex flex-col gap-4">
      <p>
        <strong className="text-white">Overview:</strong> Standard system
