    ...
    <div className="flex flex-col gap-8 w-full font-mono h-[85vh]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 shrink-0">
        <div className="border border-[#141416] bg-[#090909] p-5 flex items-start gap-4">
          ...
          <div className="flex flex-col gap-1 w-full">
            ...
            <div className="text-white text-lg font-bold">5 Nodes</div>
        ...
        <div className="border border-[#141416] bg-[#090909] p-5 flex items-start gap-4">
          ...
          <div className="flex flex-col gap-1 w-full">
            ...
            <div className="text-white text-lg font-bold">92.4%</div>
            <div className="w-full bg-[#141416] h-1 mt-2">
        ...
        >
          ...
          <div className="flex flex-col gap-1 w-full">
            ...
            <div
              className={`text-lg font-bold ${metrics.errors > 0 ? "text-[#E50914]" : "text-white"}`}
            >
              {metrics.errors > 0
      ...
      <div className="border border-[#141416] bg-[#090909] flex flex-col relative overflow-hidden group flex-1">
        ...
        <div className="p-4 border-b border-[#141416] bg-[#0D0D0F] flex justify-between items-center shrink-0">
          <h2 className="text-[0.7rem] font-bold uppercase tracking-[0.2em] text-white flex items-center gap-2">
            ...
            <tbody>
              {requests.map((req) => (
                ...
                >
                  ...
                  <td className="p-4 text-[#A7A7AA] truncate max-w-xs group-hover:text-white transition-colors">
                    {req.endpoint}
                  </td>
