    ...
    <div className="flex flex-col gap-8 w-full font-mono">
      <header className="flex justify-between items-end border-b border-[#141416] pb-6 relative">
        ...
        <div className="text-right flex flex-col items-end">
          ...
          <div className="text-white text-lg font-bold tracking-widest bg-[#0D0D0F] px-4 py-2 border border-[#141416] shadow-[inset_0_0_10px_rgba(0,0,0,0.5)]">
...
function LogEntry({
  ...
  const color = colors[level as keyof typeof colors] || "text-white";
