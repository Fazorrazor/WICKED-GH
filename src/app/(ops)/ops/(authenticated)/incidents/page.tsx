        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="w-full max-w-2xl border border-[#E50914]/50 bg-[#050505] shadow-2xl relative">
            ...
            <div className="p-6 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className="bg-[#090909] border border-[#141416] p-3 text-sm text-white outline-none focus:border-[#E50914]/50 transition-colors"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-2">
                  ...
                  <select
                    ...
                    className="bg-[#090909] border border-[#141416] p-3 text-sm text-white outline-none focus:border-[#E50914]/50 appearance-none cursor-pointer"
                  >
              ...
              <div className="flex flex-col gap-2 mt-2">
                ...
                <textarea
                  ...
                  className="bg-[#090909] border border-[#141416] p-3 text-sm text-white outline-none focus:border-[#E50914]/50 transition-colors resize-none"
            ...
            <footer className="p-4 border-t border-[#141416] flex justify-end gap-4 bg-[#090909]">
              <button
                onClick={() => setIsDeclaring(false)}
                className="px-4 py-2 text-[0.65rem] uppercase tracking-widest text-[#68686F] hover:text-white transition-colors"
              >
                Cancel
              </button>
              <button
