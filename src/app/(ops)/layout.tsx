...
export default function OpsRootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${inter.variable} ${mono.variable} dark ops-portal`}
    >
      {/* Ops body gets a deep #050505 background */}
      <body className="min-h-screen w-full bg-[#050505] text-white font-sans antialiased selection:bg-[#E50914] selection:text-white">
